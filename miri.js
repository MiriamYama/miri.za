...
if (!vapidKeys.publicKey || !vapidKeys.privateKey || !vapidKeys.subject) {
    throw new Error("Las claves VAPID no están configuradas correctamente en el archivo .env");
}
...
const dbConfig = {
    host: 'bp44i2shccwvwn680vsc-mysql.services.clever-cloud.com', // Reemplaza con el host proporcionado
    user: 'ur4xoxvfegbvzofn',          // Reemplaza con tu usuario
    password: 'I0TOr2BhHDSuZQLi6OlQ',   // Reemplaza con tu contraseña
    database: 'bp44i2shccwvwn680vsc',       // Reemplaza con el nombre de la base de datos
